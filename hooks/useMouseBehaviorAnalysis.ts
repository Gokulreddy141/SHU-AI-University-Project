...
// Raised from 60s → 120s: reading a long multi-part question without touching
// the mouse for 60s is completely normal exam behaviour, not suspicious.
const INACTIVITY_THRESHOLD_MS = 120000;
const CHECK_INTERVAL_MS = 10000;       // Check every 10 seconds
const COOLDOWN_MS = 120000;            // Cooldown raised to match new threshold
